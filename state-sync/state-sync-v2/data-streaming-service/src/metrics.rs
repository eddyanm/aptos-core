...
/// Counter for the number of times the client dropped the listener
pub static CLIENT_DROPPED_LISTENER: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "aptos_data_streaming_service_client_dropped_listener",
        "Counters related to the client dropping the listener",
    )
    .unwrap()
});
